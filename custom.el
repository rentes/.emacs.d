...
; proxy settings
; ====================================================================
(setq url-proxy-services '(("no_proxy" . "127.0.0.1, 172.18.200.0/24, 
                            172.18.210.0/24, 172.18.214.0/24")
			   ("http" . "proxymaistd.efacec.pt:8080")
			   ("https" . "proxymaistd.efacec.pt:8080")))
; ====================================================================
; python jedi
; ====================================================================
